    ...
    <div className="max-w-xl mx-40 bg-slate-800 my-20 rounded shadow py-4 px-8">
      ...
      <div className="mx-10 my-2">
        <input
          ...
          placeholder="Name"
        />
        <input className="w-full py-2 my-4 text-slate-800" type="phone" placeholder="Phone" />
        <input className="w-full py-2 my-4 text-slate-800" type="email" placeholder="Email" />
      </div>
